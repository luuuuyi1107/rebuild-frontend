...
export default class FC3 extends React.PureComponent {
  constructor() {
    super()
    this.ballNumber = 3
    this.state = {
  ...
  renderNumber() {
    ...
    return (
      <div className="fc3 ball-group number">
  ...
  renderNumberWithXt() {
    ...
    return (
      <div className="fc3 ball-group small number-with-xt row">
  ...
  renderRecordDX() {
    let balls = this.props.OpenCode.split(",")
    return (
      <div className="fc3 ball-group small record-ds row">
        <span className="text time">{util.date.format(util.date.toDate(this.props.OpenTime), "hh:mm", 8)}</span>
        <span className="text issue">{this.props.GameID}期</span>
        <p className="balls">
          {balls.map((item, index) => (
