  ...
  class extends React.PureComponent {
    ...
    loadData() {
      ...
      action.post("betpost/detail", { id: tid }).then((res) => {
        ...
        const history = res.Data.History.filter((e) => {
          return e.ID != tid
        })
        ...
        util.cache.set("forum_prevData", res.Data.PostDetail)
      })
    }
    ...
    render() {
      ...
      return (
        <LayoutPage
          ...
          className="forum_ticket_desc_new"
          center={this.state.cur_game == null ? "推荐跟单" : this.state.cur_game.name}
          right={
            <div className={styles["return-button"]} onClick={this.returnToMainBetPage.bind(this)}>
              返回投注
            </div>
          }
        >
