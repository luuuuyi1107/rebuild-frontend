...
export default class extends React.PureComponent {
    ...
    tabs: [
      {
        name: "我的记录",
        filter: [
          { key: "type", type: "hidden", defaultValue: 1 },
  ...
  renderRoundDetail() {
    ...
    let defender = (roundDetail && roundDetail.UserCards) || 0
    let Challenger = (roundDetail && roundDetail.DareCards) || 0
    let status = ""
    let fistMap = {
      0: "question",
      1: "stone",
      ...
      <div className="round-info">
        <div className="item Zdian dian">
          ...
          <div className="poker dianItem">
            <div className={"fist " + fistMap[defender]}>{fistMap[defender]}</div>
          </div>
        </div>
        <div className="item Xdian dian">
          ...
          <div className="poker dianItem">
            <div className={"fist " + fistMap[Challenger]}>{fistMap[Challenger]}</div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div>
        <RecordPage
          ...
          className="goldenPK-myBetRecord"
          center="我的下注"
          renderFixed={() => <GoldenPKNavigatorBar active="mybet" PKGame="fistPK" />}
        />
          ...
          {this.state.showRoundDetail && (
            <div className="modal-inner">
              ...
              <div className="round-content">
                ...
                {defender && Challenger && (
                  <div className="title">
                    {fistMap[defender]} vs {fistMap[Challenger]}
                  </div>
                )}
