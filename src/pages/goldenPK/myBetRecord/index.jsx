        ...
        renderRow: (row, data) => {
          ...
          return (
            <div className="recordItem" key={"betRecord" + row.ID} onClick={() => this.setState({ showRoundDetail: true, roundDetail: row })}>
              ...
              {/*<p className="dd">*/}
              {/*<span>擂主昵称：{row.NickName}</span>*/}
              {/*<span>擂主ID：{row.UID}</span>*/}
              {/*<span>彩金：{row.Money}</span>*/}
              {/*<span><span className={"status "+className}>输赢：{status}</span></span>*/}
              {/*/!*<span>投注金额：<b style={{color:"#c30202"}}>{row.Money}</b>元</span>*!/*/}
              {/*</p>*/}
            </div>
          )
        },
    ...
    return (
      <div className="round-info">
        <div className="item Zdian dian">
          ...
          {/*<div className="dianItem">{roundDetail.NickName}({roundDetail.UID})</div>*/}
    ...
    return (
      <div>
        <RecordPage
          ...
          center="我的下注"
          renderFixed={() => <GoldenPKNavigatorBar active="mybet" PKGame="goldenPK" />}
        />
          ...
          {this.state.showRoundDetail && (
            <div className="modal-inner">
              ...
              <div className="round-content">
                <div className="title">
                  {/*<span>擂主：{roundDetail.NickName}</span>*/}
